...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        heroes.add(new Hero("Adrian",26,getDrawable("adrian.jpg")));
        heroes.add(new Hero("Miryam",26,getDrawable("miryam.jpg")));
        heroes.add(new Hero("Laura",26,getDrawable("laura.jpg")));
        heroes.add(new Hero("Sergio",26,getDrawable("sergio.jpg")));
        heroes.add(new Hero("Javier",26,getDrawable("javier.jpg")));
        heroes.add(new Hero("Antonio",26,getDrawable("antonio.jpg")));
        heroes.add(new Hero("David",26,getDrawable("david.jpg")));
        heroes.add(new Hero("Rafa",26,getDrawable("rafa.jpg")));
        heroes.add(new Hero("Pablo",26,getDrawable("pablo.jpg")));
        heroes.add(new Hero("Victor",26,getDrawable("victor.jpg")));
